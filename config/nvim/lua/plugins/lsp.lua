...
vim.diagnostic.config({signs = {text = {[vim.diagnostic.severity.ERROR] = "\226\151\143", [vim.diagnostic.severity.WARN] = "\226\150\178", [vim.diagnostic.severity.INFO] = "\226\150\160", [vim.diagnostic.severity.HINT] = "\226\150\161"}}})
local function _1_()
